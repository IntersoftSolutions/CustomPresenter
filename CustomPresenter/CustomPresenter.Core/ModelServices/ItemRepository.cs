...
namespace CustomPresenter.ModelServices
{
    ...
    public class ItemRepository : IItemRepository
    {
        ...
        private Item CreateItem(XElement x)
        {
            ...
            {
                item._thumbnailImage = typeof(ItemRepository).Assembly.GetManifestResourceStream("CustomPresenter.Core.Assets.Images.Thumbnail." + item.Image).ToByte();
                item._largeImage = typeof(ItemRepository).Assembly.GetManifestResourceStream("CustomPresenter.Core.Assets.Images.Large." + item.Image).ToByte();
            }
        ...
        public IEnumerable<Item> GetAll()
        {
            if (_items == null)
            {
                XDocument doc = XDocument.Load(typeof(ItemRepository).Assembly.GetManifestResourceStream("CustomPresenter.Core.Assets.Data.Inventories.xml"));
