...
using CustomPresenter.WinRT.Common;
...
namespace CustomPresenter.WinRT.Infrastructure
{
    ...
    internal sealed class ApplicationStateService : IApplicationStateService
    {
        ...
        #region IApplicationStateService Members
        ...
        /// navigation stack, which in turn gives their active <see cref="Intersoft.Crosslight.WinRT.Page"/> an opportunity
        /// to save its state.
        /// </summary>
        ...
        /// state, which in turn gives their active <see cref="Intersoft.Crosslight.WinRT.Page"/> an opportunity restore its
        /// state.
        /// </summary>
